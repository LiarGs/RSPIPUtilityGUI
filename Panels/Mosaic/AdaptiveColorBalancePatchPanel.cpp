...
std::optional<Infrastructure::Execution::ValidationIssue> AdaptiveColorBalancePatchPanel::ValidateInput() {
...
AdaptiveColorBalancePatchPanel::CollectRequest(const QString &globalSavePath) const {
    auto request = std::make_unique<Application::Execution::MosaicAdaptiveColorBalancePatchRequest>();
